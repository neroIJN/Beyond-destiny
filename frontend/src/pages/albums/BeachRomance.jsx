...
const BeachRomance = () => {
    const coverImage = "https://images.unsplash.com/photo-1606800052052-a08af7148866?auto=format&fit=crop&w=800&q=80";
    const images = [
        ...
        >
            <section className="album-hero" style={{ backgroundImage: `url(${coverImage})` }}>
                ...
                <div className="container">
                    ...
                    >
                        <span className="label-text">Pre-Shoots</span>
                        <h1>Beach Romance</h1>
                    </motion.div>
                </div>
            </section>
                            ...
                            {images.map((img, index) => (
                                ...
                                >
                                    <div className="album-image-wrap" onClick={() => setSelectedImage(img)} style={{ cursor: 'pointer' }}>
                                        <img src={img} alt={`Beach Romance - ${index + 1}`} />
                                    </div>
                                </motion.div>
                            ))}
                        </div>
