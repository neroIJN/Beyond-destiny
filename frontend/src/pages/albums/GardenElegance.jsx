...
const GardenElegance = () => {
    const coverImage = "https://images.unsplash.com/photo-1658691530647-8b1169ab7352?auto=format&fit=crop&w=600&q=80";
    const images = [
                            ...
                            {images.map((img, index) => (
                                ...
                                >
                                    <div className="album-image-wrap" onClick={() => setSelectedImage(img)} style={{ cursor: 'pointer' }}>
                                        <img src={img} alt={`Garden Elegance - ${index + 1}`} />
                                    </div>
                                </motion.div>
                            ))}
                        </div>
