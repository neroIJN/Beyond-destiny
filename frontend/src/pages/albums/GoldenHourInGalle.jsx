...
const GoldenHourInGalle = () => {
    const coverImage = "https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=800&q=80";
    const images = [
                            ...
                            {images.map((img, index) => (
                                ...
                                >
                                    <div className="album-image-wrap" onClick={() => setSelectedImage(img)} style={{ cursor: 'pointer' }}>
                                        <img src={img} alt={`Golden Hour in Galle - ${index + 1}`} />
                                    </div>
                                </motion.div>
                            ))}
                        </div>
...
export default GoldenHourInGalle;
