...
const HeritagePalace = () => {
    const coverImage = "https://images.unsplash.com/photo-1684895603976-6ba905f8d237?auto=format&fit=crop&w=600&q=80";
    const images = [
                            ...
                            {images.map((img, index) => (
                                ...
                                >
                                    <div className="album-image-wrap" onClick={() => setSelectedImage(img)} style={{ cursor: 'pointer' }}>
                                        <img src={img} alt={`Heritage Palace - ${index + 1}`} />
                                    </div>
                                </motion.div>
                            ))}
                        </div>
