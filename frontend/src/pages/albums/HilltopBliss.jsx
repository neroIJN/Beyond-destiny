...
const HilltopBliss = () => {
    const coverImage = "https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=600&q=80";
    const images = [
                            ...
                            {images.map((img, index) => (
                                ...
                                >
                                    <div className="album-image-wrap" onClick={() => setSelectedImage(img)} style={{ cursor: 'pointer' }}>
                                        <img src={img} alt={`Hilltop Bliss - ${index + 1}`} />
                                    </div>
                                </motion.div>
                            ))}
                        </div>
