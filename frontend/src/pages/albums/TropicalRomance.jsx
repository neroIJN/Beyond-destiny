...
const TropicalRomance = () => {
    const coverImage = "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=600&q=80";
    const images = [
                            ...
                            {images.map((img, index) => (
                                ...
                                >
                                    <div className="album-image-wrap" onClick={() => setSelectedImage(img)} style={{ cursor: 'pointer' }}>
                                        <img src={img} alt={`Tropical Romance - ${index + 1}`} />
                                    </div>
                                </motion.div>
                            ))}
                        </div>
...
export default TropicalRomance;
